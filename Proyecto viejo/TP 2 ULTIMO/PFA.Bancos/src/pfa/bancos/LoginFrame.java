...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jUsernameField.setName("usernameField"); // NOI18N

        jPasswordField.setName("passwordField"); // NOI18N

        jButton1.setText("Ingresar");
        jButton1.setName("ingresarBtn"); // NOI18N
    ...
    private void ingresarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarBtnActionPerformed
        ...
        Usuario usuario = usuariosDAL.Login(jUsernameField.getText(), new String(jPasswordField.getPassword()));
        if(usuario != null)
        {
            JFrame frame = null;
            switch(usuario.getRolID())
            {
                case 1:
                    ...
                    break;
                case 2:
                    frame = new AdminFrame(3);
                    break;
                case 3:
                    VigilantesDAL vDAL = new VigilantesDAL();
                                        
                    frame = new VigilanteFrame(vDAL.getPorCodigo(usuario.getNombre()));
                    break;
                default:
                    break;                    
            }
